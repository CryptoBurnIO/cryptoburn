      ...
      <div className="bg-gray-900 border border-gray-800 rounded-sm overflow-hidden mb-4 flex flex-col" style={{ maxHeight: '420px' }}>
        ...
        <div className="divide-y divide-gray-800/50 overflow-y-auto flex-1">
          {loading ? (
            ...
            <div className="p-6 text-center bg-gray-950 border border-blue-900/30 rounded-sm">
              ...
              {assets.length > 0 && (
                <div className="bg-blue-950/30 border border-blue-800/40 rounded-sm px-3 py-2">
                  <p style={{color: '#0088cc'}} className="font-mono text-sm font-bold">🔥 {assets.length} burnable found so far</p>
                </div>
              )}
            </div>
          ) : filteredAssets.length === 0 ? (
